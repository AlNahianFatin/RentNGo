...
<head>
    ...
    <title>Customer_PickupLocation</title>
...
<body>
    ...
    <form action="" onsubmit="return validatePickupDropoff(event)" style=" flex-direction: column;">
        <div class="row">
    ...
    <a href="Admin_PickupLocation_F.html">
